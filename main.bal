...
function transform(LoanRequest[] loanRequests, LoanApproval[] loanApprovals)
    ...
    Loan[] approvedLoans = getApprovedLoans(loanRequests, loanApprovals);
...
function transformLoanRequest(LoanRequest loanRequest, LoanApproval loanApproval) returns Loan {
    ...
    decimal totalInterest = grantedAmount*interest*100;
...
function getApprovedLoans(LoanRequest[] loanRequests, LoanApproval[] loanApprovals) returns Loan[] {
